...
require (
	github.com/dioad/coredns-dioadconnect v0.12.0
...
require (
	...
	github.com/dioad/auth v0.2.1 // indirect
	github.com/dioad/connect-control v0.35.0 // indirect
	github.com/dioad/generics v0.0.8 // indirect
	github.com/dioad/net v0.55.2 // indirect
